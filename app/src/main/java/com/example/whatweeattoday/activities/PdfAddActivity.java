...
import com.example.whatweeattoday.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void uploadPdfToStorage() {
        ...
        String filePathAndName = "Recipe/"+ timestamp;
        //storage reference
    ...
    private void uploadPdfInfoToDb(String uploadedPdfUrl, long timestamp) {
        ...
        //setup data to upload, also ass view count, download count while adding pdf/recipe
