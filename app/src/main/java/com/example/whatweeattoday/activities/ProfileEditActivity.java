...
import com.example.whatweeattoday.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
        ...
        reference.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG, "onFailure: Failed up upload image due to "+e.getMessage());
                        progressDialog.dismiss();
                        Toast.makeText(ProfileEditActivity.this,"Failed up upload image due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void pickImageGallery(){
        //intent to pick image from galeery
