...
import com.example.whatweeattoday.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(name)){
            ...
            //email is either not entered or email pattern is invalid, don't a;;ow to continue in that case
    ...
    private void updateUserInfo() {
        ...
        //String timestamp1 = String.valueOf(MyApplication.formatTimestamp(timestamp));
        ...
        hashMap.put("profileImage",""); //add empty, for now
